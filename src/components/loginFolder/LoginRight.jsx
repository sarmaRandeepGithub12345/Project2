...
import "./LoginRight.module.css"
const LoginRight = () => {
  const navigate = useNavigate()
  return (
    <div className="w-[100%] h-[100vh] text-[black] flex flex-col justify-center items-center  login-right-container">
      <div>
      ...
      <div className="text-[10px]  w-[60%] text-[#555555] mb-[20px]">
        <p className="  bytext flex justify-center">
          By signing in you confirm that you are 13 years of age or above and
        </p>
        <p className=" nest flex justify-center">
          agree to our
      ...
      <div className="w-[60%] flex flex-row justify-between items-center mb-[20px]">
        ...
        <p className= " orsign  text-[#8f8f8f] text-[15px]" >or Sign In with</p>
        <div className="w-[35%] bg-[#8f8f8f] h-[0.5px]"></div>
      </div>
      ...
      <div className="w-[60%] text-[14px] font-semibold text-[#a1a1a1] flex justify-center">
        <p className="textlast">I don’t have an account <span 
        onClick={(e)=>{
          e.preventDefault();
          navigate('/register')
        }} className="text-[#0261fe] cursor-pointer">Sign Up</span></p>
      </div>
    </div>
  );
};
