...
const RegistrationRight = () => {
  ...
  return (
    <div className="w-[100%] h-[100vh] text-[black] flex flex-col justify-center items-center  register-right-container">
      <div>
      ...
      <div className="w-[60%] flex justify-center items-center bg-[#DEDEDE] text-[#525252] h-[50px] rounded-[10px] mb-[20px]">
      ...
      <div className="w-[60%] flex flex-row justify-between items-center mb-[20px]">
        ...
        <p className="text-[#8f8f8f] text-[15px]">or Sign Up with</p>
        <div className="w-[35%] bg-[#8f8f8f] h-[0.5px]"></div>
      </div>
      ...
      <div className="w-[60%] text-[14px] font-semibold text-[#a1a1a1] flex justify-center">
        <p className="">I already have an account <span 
        onClick={(e)=>{
          e.preventDefault();
          navigate('/register')
        }} className="text-[#A61B1B] cursor-pointer">Sign in</span></p>
      </div>
    </div>
  );
};
